...
bool CGet(std::string aetitle,std::string call,std::string hostname,int port ,std::string  StudyInstanceUID,	std::string PatientName,std::string AccessionNumber,std::string PatienDateOfBirth,std::string StudyDate,std::string PatientID,std::string SFolder);
#endif
